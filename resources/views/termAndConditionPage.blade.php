    ...
    <div class="container" style="padding-left: 15%; padding-right: 15%">
        <div class="row" style="padding-top: 20%;">
            <div class="col-md-12" style="color: white; text-align: justify;">
                ...
                <p>
                    Rockaroma.id adalah platform media dan kolektif sosial online. Situs ini dikelola oleh Rockaroma. Selaku pengelola situs Rockaroma.id kami menyediakan sebuah jasa untuk berbagi konten secara digital dimana setiap konten atau pun kegiatan dapat direvisi atau berubah dari waktu ke waktu. Pada laman ini akan mengatur dan menjelaskan “Syarat dan Ketentuan” ketika menggunakan platform Rockaroma.id yang kami harapkan semua pengunjung dapat memahami dengan seksama mengenai syarat dan ketentuan yang ada di bawah ini sebelum mengakses situs kami. Ketika Anda mengakses dan menggunakan platform Rockaroma.id, berarti Anda telah menyetujui dan memahami “Syarat dan Ketentuan” di dalam situs ini. Jika ada yang kurang disetujui dan berkenan, mohon untuk tidak mengakses atau menggunakan situs Rockaroma.id serta kegiatan-kegiatan di dalamnya.
                </p>
                ...
                <p>
                    ...
                    <ol>
                        <li>
                            Seluruh materi dan konten setiap pengguna merupakan karya asli bukan plagiat, atau sang pengguna telah mendapatkan semua hak, lisensi, persetujuan untuk dapat menggunakan materi dan konten tersebut;
                        </li>
                        <li>
                            Setiap pengguna bertanggung jawab sepenuhnya atas materi dan konten. Maka, pengguna juga harus menjamin dan membebaskan ​Rockaroma ​dari segala bentuk kewajiban, tanggung jawab, apabila ada tuntutan, baik tuntutan hukum, ganti rugi, dan tuntutan lain dari pihak manapun atas materi atau konten yang telah diunggah di dalam situs ​<strong>Rockaroma.id</strong>​;
                        </li>
                        <li>
                            Pengguna yang memiliki materi atau konten yang merupakan karya aslinya, atau sudah layak tayang dan mendapatkan hak, izin, atau lisensi bisa memberikan wewenang kepada ​Rockaroma untuk menggunakan, mengunggah, membuat ulang, mendistribusikan, atau menampilkan kepada publik. Serta untuk mengkomunikasikan setiap materi atau konten kepada khalayak melalui situs <strong>Rockaroma.id</strong>​;
                        </li>
                        <li>
                            Pengguna yang telah mendapatkan semua persetujuan, izin, dan/atau pelepasan yang diperlukan dari setiap dan semua orang yang muncul pada konten Anda untuk memasukkan nama, suara, kinerja pada konten Anda dan untuk mempublikasikannya pada platform yang terhubung di situs ​<strong>Rockaroma.id</strong>;​
                        </li>
                        <li>
                            Materi atau konten pengguna, termasuk komentar yang Anda taruh pada situs <strong>Rockaroma.id</strong>​, ​tidak dan tidak akan melanggar hukum. Komentar bersifat ofensif, kekerasan, kejahatan, merusak, rasis, cabul, eksplisit secara seksual, ofensif terhadap etnis budaya, melecehkan orientasi seksual dan mendukung kekerasan, terorisme, atau menyebarkan ketakutan dan kebencian, atau berbau SARA dapat kami gugat nantinya;
                        </li>
                        <li>
                            Situs ini tidak dapat digunakan untuk kepentingan politik. Setiap konten atau materi yang mengandung unsur politik, baik dalam bentuk tulisan, foto, video, dan bentuk lainnya tidak diperkenankan diunggah oleh pengguna atau pengelolah di situs ​<strong>Rockaroma.id</strong>;
                        </li>
                        <li>
                            Materi atau konten pengguna tidak dan tidak akan menciptakan kewajiban apapun pada ​Rockaroma​, pihak sponsor, para pemilik modal, anak perusahaan, afiliasi, penerus dan penerima pengalihan ​Rockaroma​, dan masing-masing karyawan, agen, direktur, komisaris, pejabat dan/atau para pemegang sahamnya lainnya.
                        </li>
                    </ol>
                </p>
