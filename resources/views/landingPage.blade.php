                ...
                <center>
                    <div class="card w3-animate-top" style="width: 17.75rem;">
                        <div class="container-card" >
                            ...
                            <div class="overlay">
                                <a href="{{isset($articles[1]['id'])?url('article-detail-page').'/'. $articles[0]['title'] .'/'.$articles[1]['id']:'#'}}"><div class="text-card">Read More</div></a>
                            </div>
                        </div>
                        <div class="card-body" >
                            <p class="card-text" style="text-align: left;">
                ...
                <center>
                    <div class="card w3-animate-top" style="width: 17.75rem;">
                        <div class="container-card" >
                            ...
                            <div class="overlay">
                                <a href="{{isset($articles[2]['id'])?url('article-detail-page').'/'. $articles[0]['title'] .'/'.$articles[2]['id']:'#'}}"><div class="text-card">Read More</div></a>
                            </div>
                        </div>
                        <div class="card-body" >
                            <p class="card-text" style="text-align: left;">
